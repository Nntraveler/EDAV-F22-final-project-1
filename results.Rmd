...
From the histogram above, we can see that there are generally more males than females in the victims. And other types of gender only occupy very small proportions.
